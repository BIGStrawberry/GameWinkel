    ...
    <div class="container youplay-store">
      ...
      <div class="col-md-9 isotope">
        ...
        <div class="isotope-list">
          ...
          <?php
             echo "
             <a href='../dark/product-page.php?id=".$row["id"]."' class='item angled-bg' data-filters='".$row["platform"]."'>
              <div class='row'>
                <div class='col-lg-2 col-md-3 col-xs-4'>
                  <div class='angled-img'>
                    <div class='img'>
                      <img src='../assets/images/games/". $row["id"] .".jpg' alt='logo' height='85' width='85'>
                    </div>
                  </div>
                </div>
               <div class='col-lg-10 col-md-9 col-xs-8'>
                  <div class='row'>
                    <div class='col-xs-6 col-md-9'>
                      <h4>". $row["name"] ." - Platform: ".$row["platform"]."</h4>
                      <div class='rating'>
